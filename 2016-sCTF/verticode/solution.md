...
##Solution
1. We wrote some python to extract the flag
2. After running this we get the output
   ...
   ```
3. this line looks interesting and is also the flag `sctf{iamtheflagalllowercasenojoke}`
